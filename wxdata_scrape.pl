...
# Renamed wxdata_scrape.pl and started to strip out unneeded functionality.
#
...
my $hostaddr = inet_ntoa(scalar 10.0.0.251);
...
while(1) {	# TCP socket send/receive loop
    ...
    print "Outdoor temp (F) is: $msgcontent[13]\n";
    ...
    print "Outdoor temp (C) is: $ewdata[9]\n";
